...
namespace Pacman
{
    class DeadState : State
    {
        ...
        {
            StringManager.DrawStringMid(aSpriteBatch, my8bitFont, "GAME OVER", new Vector2(aWindow.ClientBounds.Width / 2, (aWindow.ClientBounds.Height / 2) - 96), Color.Red, 1.2f);
